		...
		<section id="main">
			<div class="container">
				...
				<div class="slider">
					...
					<a  href="produs.php?category_name=<?php echo $category_name;?>" ><figure class="mobile">
					...
					<a href="produs.php?category_name=<?php echo $category_name; ?>" >Mobile Phones </a>
				</div>
				...
				<div class="slider">
					...
					<a href="produs.php?category_name=<?php echo $category_name;?>">Cars</a>
				</div>
					...
					<a href="produs.php?category_name=<?php echo $category_name;?>">Houses </a>
				</div>
				...
				<div class="slider">
					...
					<a href="produs.php?category_name=<?php echo $category_name;?>">TV </a>
				</div>
				...
				<div class="slider">
					...
					<a href="produs.php?category_name=<?php echo $category_name;?>">PC </a>
				</div>
					...
					<a href="produs.php?category_name=<?php echo $category_name;?>">Clothes </a>
				</div>
