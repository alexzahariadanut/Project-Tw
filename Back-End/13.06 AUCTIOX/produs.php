<?php
	...
	session_start();
	$username="iuliangabriel" // utilizatorul curent
?>
		...
		<section id="main">
			<div class="container">		
				...
				<?php
					...
					$sql="select * from products join categories on products.category_id=categories.category_id where categories.category_name='Cars' order by product_id asc";
					$result=mysqli_query($conn,$sql); // toate coloanele din tabelul products  pentru produsele din categoria 'Cars'
