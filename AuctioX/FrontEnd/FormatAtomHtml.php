...
xmlhttp.open("GET","AtomFormat.xml",false);
xmlhttp.send();
...
document.write("<tr><th>Roll</th><th>NumeObiect</th><th>Descriere</th><th>Seller_id</th><th>DataLicitatie</th></th>");
...
for(i=0;i<x.length;i++)
{
	...
	document.write(xmlDoc.getElementsByTagName("NumeObiect")[i].childNodes[0].nodeValue);
	document.write("/</td><td>");
	document.write(xmlDoc.getElementsByTagName("Descriere")[i].childNodes[0].nodeValue);
	document.write("/</td><td>");
	document.write(xmlDoc.getElementsByTagName("Seller_id")[i].childNodes[0].nodeValue);
	document.write("/</td><td>");
	document.write(xmlDoc.getElementsByTagName("DataLicitatie")[i].childNodes[0].nodeValue);
	document.write("/</td><td>");
