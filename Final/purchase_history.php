		...
		<header>
			...
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="Xml.php"> <img id="side-pics4" src="./img/payment.jpg" alt="Payment Icon"> XML generare</a></li>
					<li><a href="generatePdf.php"> <img id="side-pics4" src="./img/payment.jpg" alt="Payment Icon"> PDF 
